...
document.addEventListener('DOMContentLoaded', () => {
    ...
    daysSubmit.addEventListener('submit', (e) => {
        ...
        const percentage = parseFloat(document.querySelector('#days #user-percentage').value);
        ...
        for (let i = 0; i < iterations; i++) {
            let earnings = amount * (percentage / 100);
            amount += earnings;
            ...
            if(level === 1) {
                if(amount >= 500 && counter === 0) {
                    newRow.style.background = "green";
                    counter++;
                }
            } else if (level === 2) {
                if(amount >= 2000 && counter === 0) {
                    counter++;
                    newRow.style.background = "green";
                }
            } 
    ...
    amountSubmit.addEventListener('submit', (e) => {
        ...
        const percentage = parseFloat(document.querySelector('#amount #user-percentage').value);
